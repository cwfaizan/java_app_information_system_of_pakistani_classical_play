...
<tr><td><h1 align="center">Information Retrieval System</h1><br><h2 align="center">Query Results</h2><br></td>
<td><ul>
...
<tr><td>
<a href="links_y.jsp?key=<%=request.getAttribute("key")%>"><%=request.getAttribute("key")%></a>
</td></tr>
</table>
</td></tr>
</table>
